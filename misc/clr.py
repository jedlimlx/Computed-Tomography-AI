# from https://github.com/titu1994/keras-one-cycle/blob/master/clr.py
...
class CLR(LearningRateSchedule):
    def __init__(self, num_samples, batch_size, epochs, max_lr, end_percentage):
        ...
        self.scale = end_percentage

        self.steps_per_epoch = num_samples // batch_size if num_samples % batch_size == 0 else num_samples // batch_size + 1
        self.total_steps = self.steps_per_epoch * epochs
        self.mid_cycle_id = int(self.total_steps * (1. - end_percentage) / float(2))
